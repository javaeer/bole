		...
		<view class="edit-header">
			<view class="header-content">
				...
				<view class="header-actions">
					<button class="btn-save" :class="{ 'btn-save--loading': saving }"
						:disabled="!isFormChanged || saving || uploadingAvatar" @click="handleSave">
		...
		<scroll-view class="edit-content" scroll-y="true">
					...
					<view v-if="uploadingAvatar" class="upload-mask">
						<view class="upload-progress">
							<view class="progress-circle">
								...
								<view class="circle-fill" :style="{ transform: `rotate(${uploadProgress * 3.6}deg)` }">
								</view>
							</view>
			...
			<view class="form-section">
				...
				<view class="form-item">
					...
					<input v-model="formData.name" class="form-input" type="text" placeholder="请输入姓名"
						placeholder-class="placeholder" maxlength="20" @input="handleInputChange('name')" />
				...
				<view class="form-item">
					...
					<input v-model="formData.title" class="form-input" type="text" placeholder="请输入职称或职位"
						placeholder-class="placeholder" maxlength="50" @input="handleInputChange('title')" />
				...
				<view class="form-item">
					...
					<textarea v-model="formData.bio" class="form-textarea" placeholder="请简单介绍一下自己..."
						placeholder-class="placeholder" maxlength="200" auto-height @input="handleInputChange('bio')" />
			...
			<view class="form-section">
				...
				<view class="form-item">
					...
					<input v-model="formData.username" class="form-input" type="text" placeholder="请输入账号名"
						placeholder-class="placeholder" maxlength="20" @input="handleInputChange('username')" />
				...
				<view class="form-item">
					...
					<picker mode="region" :value="formData.region" @change="handleRegionChange">
				...
				<view class="form-item">
					...
					<input v-model="formData.github" class="form-input" type="text" placeholder="GitHub用户名"
						placeholder-class="placeholder" @input="handleInputChange('github')" />
				</view>

				<!-- 个人网站 -->
				<view class="form-item">
					<text class="item-label">个人网站</text>
					<input v-model="formData.website" class="form-input" type="text" placeholder="https://"
						placeholder-class="placeholder" @input="handleInputChange('website')" />
				</view>

				<!-- 所在公司 -->
				<view class="form-item">
					<text class="item-label">所在公司</text>
					<input v-model="formData.company" class="form-input" type="text" placeholder="请输入公司名称"
						placeholder-class="placeholder" maxlength="50" @input="handleInputChange('company')" />
				</view>
			</view>
