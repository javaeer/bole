...
public class WorkExperienceController {
    ...
    public ResponseEntity<BusinessResponse<Boolean>> del(
        ...
        return ResponseEntity.ok(BusinessResponse.success(workExperienceService.removeById(id)));
    }
    ...
    public ResponseEntity<BusinessResponse<WorkExperience>> get(
            @PathVariable(value = "id") Long id) {
        return ResponseEntity.ok(BusinessResponse.success(workExperienceService.getById(id)));
    }

    @PostMapping("page")
    @Operation(summary = "获取工作经历列表")
    public ResponseEntity<BusinessResponse<Page<WorkExperience>>> page(
