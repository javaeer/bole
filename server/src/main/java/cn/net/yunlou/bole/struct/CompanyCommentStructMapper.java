...
/**
 * FileName: CompanyCommentStructMapper
 * Description:
 * Created By MR. WANG
...
public interface CompanyCommentStructMapper extends BaseStructMapper<CompanyComment, CompanyCommentDTO, CompanyCommentQuery> {
}
