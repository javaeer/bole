...
public class QueryUtils {
    ...
    public static <M> Map<String, Object> modelToMap(M model, boolean convertFieldName) {
        ...
        try {
            ...
            log.debug("Successfully converted BaseQuery to map: {}", model.getClass().getSimpleName());
            return map;

        } catch (Exception e) {
            log.error("Failed to convert BaseQuery to map: {}", model.getClass().getSimpleName(), e);
     ...
     * @return 转换后的Bean列表
     */
    public static <T> List<T> modelToBeans(List<? extends BaseQuery> models, Class<T> clazz, boolean convertFieldName) {
     ...
     * @return 转换后的BaseQuery
     */
    public static <T extends BaseQuery> T beanToModel(Object bean, Class<T> modelClass, boolean convertFieldName) {
        if (bean == null) {
            return null;
        }
