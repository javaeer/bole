...
/**
 * FileName: RegionServiceImpl Description: Created By laughtiger Created At 2026/1/2 23:11 Modified
 * By Modified At
 */
@Service
...
public class RegionServiceImpl
    ...
    public RegionView findNearestRegion(Double longitude, Double latitude, Integer level) {
        ...
        for (Region entity : entities) {
            double distance =
                    calculateDistance(
                            longitude, latitude, entity.getLongitude(), entity.getLatitude());
