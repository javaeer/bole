...
/**
 * FileName: CompanyExperienceServiceImpl
 * Description:
 * Created By MR. WANG
 * Created At 2025/11/24 23:26
 * Modified By
 * Modified At
 */
@Service
public class CompanyExperienceServiceImpl extends BaseService<CompanyExperienceMapper,CompanyExperience, CompanyExperienceDTO, CompanyExperienceQuery, CompanyExperienceStructMapper> implements CompanyExperienceService {
}
