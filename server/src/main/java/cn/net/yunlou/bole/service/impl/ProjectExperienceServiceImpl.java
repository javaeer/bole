...
/**
 * FileName: ProjectExperienceServiceImpl
 * Description:
 * Created By MR. WANG
 * Created At 2025/11/24 23:48
 * Modified By
 * Modified At
 */
@Service
public class ProjectExperienceServiceImpl extends BaseService<ProjectExperienceMapper, ProjectExperience, ProjectExperienceDTO, ProjectExperienceQuery, ProjectExperienceStructMapper> implements ProjectExperienceService {
}
