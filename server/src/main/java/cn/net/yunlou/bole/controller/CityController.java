...
public class CityController {
    ...
    public ResponseEntity<BusinessResponse<Boolean>> add(
        ...
        return ResponseEntity.ok(BusinessResponse.success(cityService.save(city)));
    }
    ...
    public ResponseEntity<BusinessResponse<Boolean>> del(
        ...
        return ResponseEntity.ok(BusinessResponse.success(cityService.removeById(id)));
    }
    ...
    public ResponseEntity<BusinessResponse<Boolean>> edit(
        ...
        City city = QueryUtils.modelToBean(request, City.class);
        return ResponseEntity.ok(BusinessResponse.success(cityService.updateById(city)));
    }


    @GetMapping("{id}")
    @Operation(summary = "获取城市信息")
    public ResponseEntity<BusinessResponse<City>> get(
            @PathVariable(value = "id") Long id) {
        return ResponseEntity.ok(BusinessResponse.success(cityService.getById(id)));
    }

    @PostMapping("page")
    @Operation(summary = "获取城市列表")
    public ResponseEntity<BusinessResponse<Page<CityDTO>>> page(
        ...
        return ResponseEntity.ok(BusinessResponse.success(cityService.pageDTOByQuery(page, size, request)));
    }
