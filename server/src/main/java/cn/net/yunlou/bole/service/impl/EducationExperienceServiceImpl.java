...
/**
 * FileName: EducationExperienceServiceImpl
 * Description:
 * Created By MR. WANG
 * Created At 2025/11/24 23:40
 * Modified By
 * Modified At
 */
@Service
public class EducationExperienceServiceImpl extends BaseService<EducationExperienceMapper,EducationExperience, EducationExperienceDTO, EducationExperienceQuery, EducationExperienceStructMapper> implements EducationExperienceService {
}
